...
import com.example.javaproject.Adapter.MessageAdapter;
import com.example.javaproject.Model.Chat;
...
SeenMessage(userid);
    ...
    private void sendMessage(String sender, String reveiver, String message)
    {
